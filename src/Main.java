...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int difficulty;
        do {
            System.out.print("Difficulty (1 = easy, 2 = normal, 3 = brutal, 4 = grimm): ");
            while (!in.hasNextInt()) {
        ...
        while (playing) {
            ...
            System.out.print("[A]ttack  [D]efend  [F]ocus  [R]un: ");
            ...
            switch (action) {
                ...
                case "F" -> {
                    if (aura > 0) {
                        aura--;
                        health += 25;
                        System.out.println("You drink a Focus on your Aura and recover 25 HP.");
                    } else {
